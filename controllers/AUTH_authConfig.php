 ...
 */
class AUTH_authConfig extends PHPDS_controller
{
    /**
    ...
    public function execute()
    {
        ...
        $defaultAuthClass
            = (!empty($configuration['auth']['default'])) ? $configuration['auth']['default'] : '';

        $view->set('defaultAuthClass', $defaultAuthClass);
