...
{
    //for flexibility all user data are stored in an array
    ...
    /**
     * Add the user to a group (ie. add the group ID to the user's list)
     *
    ...
    /**
     * Remove the user from a group (ie. delete the group ID from the user's list)
     *
     * @param integer $groupID
     *
     * @return void
